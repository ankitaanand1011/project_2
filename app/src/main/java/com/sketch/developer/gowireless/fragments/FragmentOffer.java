...
public class FragmentOffer extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // list_product = new ArrayList<>();
        ...
        getProductByCatId_url();

        return  view;
    }

    public void getProductByCatId_url(){

        pd.show();

        String url = WebserviceUrl.getProductByCatId;
        AsyncHttpClient cl = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        params.put("store_name",WebserviceUrl.Storename);
        params.put("show_all_product_only", "Y");
