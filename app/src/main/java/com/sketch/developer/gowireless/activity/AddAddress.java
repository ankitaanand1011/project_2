...
public class AddAddress extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        prefrence = new Shared_Prefrence(AddAddress.this);
                                ...
                                if (!country_idd.isEmpty()) {
                                    if (!state_idd.isEmpty()) {
                                        if (!city_idd.isEmpty()) {
                                            ...
                                            AddCustomerShipAddress(input_address.getText().toString(),
                                                    input_zip.getText().toString(), input_mobile.getText().toString());

                                        } else {Toasty.warning(AddAddress.this, "Please enter city name.", Toast.LENGTH_SHORT, true).show();}
                                    } else {Toasty.warning(AddAddress.this, "Please enter state name.", Toast.LENGTH_SHORT, true).show();}
                                } else {Toasty.warning(AddAddress.this, "Please enter country name.", Toast.LENGTH_SHORT, true).show();}
                            } else {Toasty.warning(AddAddress.this, "Please enter zip code.", Toast.LENGTH_SHORT, true).show();}
                        } else {Toasty.warning(AddAddress.this, "Please enter mobile number.", Toast.LENGTH_SHORT, true).show();}
                    } else {Toasty.warning(AddAddress.this, "Please enter address.", Toast.LENGTH_SHORT, true).show();}
                } else {Toasty.info(AddAddress.this, "Check your internet connection", Toast.LENGTH_SHORT, true).show();}
            }
    ...
    public void GetCountry(){
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
                    ...
                    try {
                        ...
                        if (status == 0){
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>
                                    (AddAddress.this,android.R.layout.simple_list_item_1, array_country_name);
            ...
            public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                ...
                android.app.AlertDialog alert = new android.app.AlertDialog.Builder(AddAddress.this).create();
                ...
                if (response != null) {
                    try {
                        ...
                        if (status == 0){
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>
                                    (AddAddress.this,android.R.layout.simple_list_item_1, array_state_name);
                ...
                if (response != null) {
                    try {
                        ...
                        if (status == 0){
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>
                                    (AddAddress.this,android.R.layout.simple_list_item_1, array_city_name);
    ...
    public void AddCustomerShipAddress(String street, String zipcode, String mobile){
        ...
        String url = WebserviceUrl.addCustomerShipAddress;
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        ...
        Log.d(TAG , "addCustomerShipAddress- " + url);
        Log.d(TAG ,"addCustomerShipAddress- " + params.toString());
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                   ...
                   Log.d(TAG, "addCustomerShipAddress- " + response.toString());
                if (response != null) {
                    try {
                        ...
                        if (status == 0){
                            ...
                            Toasty.error(AddAddress.this, ""+message, Toast.LENGTH_SHORT, true).show();
                        }else if (status == 1){

                            //Toast.makeText(AddAddress.this, "Added", Toast.LENGTH_LONG).show();
                            Toasty.success(AddAddress.this, ""+message, Toast.LENGTH_SHORT, true).show();
                            finish();
                        }
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                Log.d("TAG", "addCustomerShipAddress- " + res);
